...
/***********************************************
 * Setup function:                             *
 *   connects via WiFi, reads every sensor     *
 *   once and go to deep sleep.                *
 *   After deep sleep the ESP8266 restarts     *
 ***********************************************/
void setup() {
  ...
  pinMode(D0, WAKEUP_PULLUP);			//D0 have to be connected with RST
  ESP.deepSleep(60 * DELAY * 1000000);	//Deep sleep for DELAY and restarts the board
}
